...
index_no|lexeme_name|Return_type|Data_type|token_type|NO_of_arguments|
*/
...
const char *Keywords[] = {"const", "char","void","int","sizeof","bool","float", "return", "for", "while", "do", "switch", "if", "else", "unsigned", "case", "break"};
const char *ReturnTypes[] = {"int","float","char","void","bool"};
